...
#include "task3/srv/detail/custom_service__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task3::srv::CustomService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task3::srv::CustomService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task3::srv::CustomService_Request *>(
    untyped_ros_message);
...
{
  return &task3::srv::typesupport_fastrtps_cpp::_CustomService_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task3::srv::CustomService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task3::srv::CustomService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task3::srv::CustomService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task3::srv::typesupport_fastrtps_cpp::_CustomService_Response__handle;
}
...
{
  return &task3::srv::typesupport_fastrtps_cpp::_CustomService__handle;
}
